...
namespace Application.Services
{
    public class ApartmentService : IApartmentService
    {
        ...
        public async Task<int> Add(CreateApartmentRequest apartment)
        {
            ...
            _logger.LogInformation("Apartment was created with id: {ApartId}", result);
            return result;
        }
        ...
        public async Task<bool> Delete(int id)
        {
            ...
            _logger.LogInformation("Apartment with id: {DealId} was deleted", id);
        ...
        public async Task<bool> Update(UpdateApartmentRequest apartment)
        {
            ...
            _logger.LogInformation("Apartment with id: {ApartId} was updated", apartment.Id);
            return true;
        }
    }
}